<template>
  <div>
    ...
    <el-menu mode="vertical" class="sidemenu" :unique-opened=true background-color="#364150" text-color="#fff" :collapse="isCollapse" active-text-color="#fff"  :default-active="activeRoute" >
