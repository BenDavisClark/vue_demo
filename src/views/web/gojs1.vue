  ...
  mounted(){
    ...
    mySelf.myDiagram.nodeTemplate =
      MAKE(go.Node,
        ...
        MAKE(go.Shape, "RoundedRectangle", { fill: "#44CCFF",stroke: 'green',strokeWidth:2,angle:0 }),
    ...
    myModel.nodeDataArray =
      [ // note that each node data object holds whatever properties it needs;
        ...
        {key:"1", name1: "董事长"},
        {key:"2", parent:"1", name1: "秘书" },
        {key:"3", parent:"1", name1: "CEO"},
        {key:"4", parent:"3", name1: "总经理"},
        {key:"5", parent:"4", name1: "二狗子"},
      ];
